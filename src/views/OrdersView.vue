...
onMounted(async () => {
  ...
  try {
    ...
    const data = await fetchCommandeByClient(String(auth.user.id))
  ...
  <div class="max-w-7xl mx-auto px-4 py-10">
    ...
    <div v-else>
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div v-for="(commande, idx) in commandes" :key="idx" class="bg-white rounded-xl shadow-sm overflow-hidden transition hover:shadow-md cursor-pointer" @click="goToOrder(idx)">
          <div class="p-4">
